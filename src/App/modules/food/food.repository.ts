...
export class FoodRepository{
  ...
  private readonly clientDynamo = new DynamoDBClient({region:this.configService.getOrThrow('AWS_S3_REGION')})
  ...
  async upsertOne(data: Food) {
    ...
    const command = new PutItemCommand({ TableName: this.tableName, Item: itemObject });
